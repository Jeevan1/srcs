...
const ProjectCard = ({ project }: { project: Projects }) => {
  return (
    <div className="w-full transform cursor-pointer space-y-3 overflow-hidden rounded-md bg-white shadow-sm duration-200 hover:shadow-lg">
      ...
      <div className="flex items-start justify-between gap-6 px-4 pt-1">
        ...
        <p className="rounded-md border border-gray-200 px-2 py-1 text-xs font-semibold capitalize">
          {project.category}
        </p>
      </div>
